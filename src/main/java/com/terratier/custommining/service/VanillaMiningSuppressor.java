...
public final class VanillaMiningSuppressor {
    ...
    public VanillaMiningSuppressor(Plugin plugin, BlockIdentityResolver blockResolver) {
    ...
    public void tick(MiningConfig config) {
