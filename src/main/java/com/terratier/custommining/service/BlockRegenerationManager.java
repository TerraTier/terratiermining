...
public final class BlockRegenerationManager {
    ...
    public void shutdown() {
        regeneratingLocations.clear();
    }

    public void queueRegeneration(Block block, BlockData originalData, MiningRule rule, Runnable onComplete) {
