...
public final class MiningCalculator {
    ...
    public MiningCalculator(ToolIdentityResolver toolResolver, MiningBuffResolver buffResolver, NamespacedKey vanillaSuppressionKey) {
        this.toolResolver = toolResolver;
        this.buffResolver = buffResolver;
        this.vanillaSuppressionKey = vanillaSuppressionKey;
    }

    public ToolStats resolveTool(Player player, MiningConfig config) {
