...
public record TerraTierItemAttribute(String attribute, double value, String source, String slot) {
    public static TerraTierItemAttribute inventory(String attribute, double value) {
        return new TerraTierItemAttribute(attribute, value, "inventory", null);
    }

    public boolean appliesTo(BuffSourceType sourceType, EquipmentSlot equipmentSlot) {
